    ...
    public boolean ifWon(JButton[] buttons)
    {
       ...
       if( (buttons[i].getText().equals(buttons[++i].getText()) && buttons[i].getText().equals(buttons[++i].getText())) ||(buttons[j].getText().equals(buttons[++j].getText()) && buttons[j].getText().equals(buttons[++j].getText())) ||(buttons[k].getText().equals(buttons[++k].getText()) && buttons[k].getText().equals(buttons[++k].getText()))  )
        ...
        return true;
               ...
               if ((buttons[i2].getText().equals(buttons[i2+4].getText()) && buttons[i2+4].getText().equals(buttons[i2+8].getText())) || (buttons[j2].getText().equals(buttons[j2+2].getText()) && buttons[j2+2].getText().equals(buttons[j2+4].getText())))
               return true;
      ...
      public boolean ifWon1(JButton[] buttons)
      {
          ...
          if((buttons[0].getText().equals(buttons[3].getText()) &&buttons[3].getText().equals(buttons[6].getText())) ||(buttons[j1].getText().equals(buttons[j1+3].getText()) &&buttons[j1+3].getText().equals(buttons[j1+6].getText())) ||(buttons[k1].getText().equals(buttons[k1+3].getText()) &&buttons[k1+3].getText().equals(buttons[k1+6].getText())))
              return true;
          else
          if ((buttons[0].getText().equals(buttons[4].getText()) && buttons[4].getText().equals(buttons[8].getText())) || (buttons[2].getText().equals(buttons[4].getText()) && buttons[4].getText().equals(buttons[8].getText())))
              return true;
